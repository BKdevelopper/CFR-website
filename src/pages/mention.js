    ...
    <div>
      ...
      <article className="article">
        <div className="article-container">
          ...
          <h2 className="mention-h2">1. Présentation du site internet.</h2>
          <p className="mention-p">
            ...
            l&rsquo;identité des différents intervenants dans le cadre de sa
          ...
          <h2 className="mention-h2">3. Description des services fournis.</h2>
          <p className="mention-p">
            Le site internet{' '}
            <a className="mention-a" href="https://moncfr.fr/">
              https://moncfr.fr/
          ...
          <h2 className="mention-h2">6. Limitations de responsabilité.</h2>
          <p className="mention-p">
            <a className="mention-a" href="https://moncfr.fr/">
              https://moncfr.fr/
            </a>{' '}
          ...
          <h2 className="mention-h2">7. Gestion des données personnelles.</h2>
          <p className="mention-p">
          ...
          <h3 className="mention-h3">7.2 Finalité des données collectées</h3>
          <p className="mention-p">
            <a className="mention-a" href="https://moncfr.fr/">
              https://moncfr.fr/
            </a>{' '}
          ...
          <div>
            <h3 className="mention-h3">7.5 Types de données collectées</h3>
            <p className="mention-p">
          ...
          <h2 className="mention-h2">8. Notification d’incident</h2>
          <p className="mention-p">
          ...
          <p className="mention-p">
            ...
            n&rsquo;est publiée à l&rsquo;insu de l&rsquo;utilisateur, échangée,
            transférée, cédée ou vendue sur un support quelconque à des tiers.
            Seule l&rsquo;hypothèse du rachat de{' '}
            <a className="mention-a" href="https://moncfr.fr/">
              https://moncfr.fr/
            </a>{' '}
            et de ses droits permettrait la transmission des dites informations
            à l&rsquo;éventuel acquéreur qui serait à son tour tenu de la même
          ...
          <h3 className="mention-h3">Sécurité</h3>
          <p className="mention-p">
          ...
          <h3 className="mention-h3">9.1. « COOKIES »</h3>
          <p className="mention-p">
          ...
          <h3 className="mention-h3">Article 9.2. BALISES (“TAGS”) INTERNET</h3>
          <p className="mention-p">
            <a className="mention-a" href="https://moncfr.fr/">
              https://moncfr.fr/
            </a>{' '}
